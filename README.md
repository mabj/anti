...
[![Techniques](https://img.shields.io/badge/Techniques-59-brightgreen.svg)]()
[![Anti-Debugger](https://img.shields.io/badge/Anti--Debugger-51-red.svg)](anti-debugger/)
...
This repository documents 59 real-world anti-analysis techniques discovered during malware research and reverse engineering. Each technique is implemented as a standalone proof-of-concept with source code, build instructions, and detailed documentation.
...
- 🛡️ **Anti-Debugger** (51 techniques): Detect debuggers and prevent debugging
...
- `anti-debugger/` - 51 techniques for detecting debuggers
...
- **Anti-Debugger** (51 techniques): Techniques that detect debuggers attached to or monitoring the process. Includes PEB checks, exception-based detection, breakpoint scanning, and self-protection mechanisms.
...
> 📊 **Distribution**: 86.4% Anti-Debugger | 13.6% Anti-Sandbox | 0% Anti-Reversing
