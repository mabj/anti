...
[![Techniques](https://img.shields.io/badge/Techniques-49-brightgreen.svg)]()
[![Anti-Debugger](https://img.shields.io/badge/Anti--Debugger-41-red.svg)](anti-debugger/)
...
This repository documents 49 real-world anti-analysis techniques discovered during malware research and reverse engineering. Each technique is implemented as a standalone proof-of-concept with source code, build instructions, and detailed documentation.
...
- 🛡️ **Anti-Debugger** (41 techniques): Detect debuggers and prevent debugging
...
- `anti-debugger/` - 41 techniques for detecting debuggers
...
- **Anti-Debugger** (41 techniques): Techniques that detect debuggers attached to or monitoring the process. Includes PEB checks, exception-based detection, breakpoint scanning, and self-protection mechanisms.
...
> 📊 **Distribution**: 83.7% Anti-Debugger | 16.3% Anti-Sandbox | 0% Anti-Reversing
