...
[![Techniques](https://img.shields.io/badge/Techniques-47-brightgreen.svg)]()
[![Anti-Debugger](https://img.shields.io/badge/Anti--Debugger-39-red.svg)](anti-debugger/)
...
This repository documents 47 real-world anti-analysis techniques discovered during malware research and reverse engineering. Each technique is implemented as a standalone proof-of-concept with source code, build instructions, and detailed documentation.
...
- 🛡️ **Anti-Debugger** (39 techniques): Detect debuggers and prevent debugging
...
- `anti-debugger/` - 39 techniques for detecting debuggers
...
```mermaid
graph TB
    A[Anti-Analysis Techniques<br/>47 Total] --> B[Anti-Debugger<br/>39 techniques<br/>83.0%]
    A --> C[Anti-Sandbox<br/>8 techniques<br/>17.0%]
...
- **Anti-Debugger** (39 techniques): Techniques that detect debuggers attached to or monitoring the process. Includes PEB checks, exception-based detection, breakpoint scanning, and self-protection mechanisms.
...
> 📊 **Distribution**: 83.0% Anti-Debugger | 17.0% Anti-Sandbox | 0% Anti-Reversing
