...
[![Techniques](https://img.shields.io/badge/Techniques-52-brightgreen.svg)]()
[![Anti-Debugger](https://img.shields.io/badge/Anti--Debugger-44-red.svg)](anti-debugger/)
...
This repository documents 52 real-world anti-analysis techniques discovered during malware research and reverse engineering. Each technique is implemented as a standalone proof-of-concept with source code, build instructions, and detailed documentation.
...
- 🛡️ **Anti-Debugger** (44 techniques): Detect debuggers and prevent debugging
...
- `anti-debugger/` - 44 techniques for detecting debuggers
...
```mermaid
graph TB
    A[Anti-Analysis Techniques<br/>52 Total] --> B[Anti-Debugger<br/>44 techniques<br/>84.6%]
    A --> C[Anti-Sandbox<br/>8 techniques<br/>15.4%]
...
- **Anti-Debugger** (44 techniques): Techniques that detect debuggers attached to or monitoring the process. Includes PEB checks, exception-based detection, breakpoint scanning, and self-protection mechanisms.
...
> 📊 **Distribution**: 84.6% Anti-Debugger | 15.4% Anti-Sandbox | 0% Anti-Reversing
