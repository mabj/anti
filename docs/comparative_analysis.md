...
1. **This project** (`anti`) - 55 techniques
...
| **Anti-Debugger** | 47 techniques | ~34 techniques | 62 techniques |
...
| -------- | :-----------: | :---------: | :-----------: |
| Total anti-debug techniques | 47 | ~34 | 62 |
| Shared with Check Point | 41 / 62 (66%) | ~25 / 62 (40%) | - |
