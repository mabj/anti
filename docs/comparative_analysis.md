...
1. **This project** (`anti`) - 54 techniques
...
| **Anti-Debugger** | 46 techniques | ~34 techniques | 62 techniques |
...
| -------- | :-----------: | :---------: | :-----------: |
| Total anti-debug techniques | 46 | ~34 | 62 |
| Shared with Check Point | 40 / 62 (65%) | ~25 / 62 (40%) | - |
